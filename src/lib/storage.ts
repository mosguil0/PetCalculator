...
export const VERSAO_ATUAL = 2; // Incremented version because of the schema update

export const MEDICAMENTOS_PADRAO: Medicamento[] = [
  { id: "1", nome: "Drontal Plus Sabor Carne (Cães)", categoria: "Vermífugo", pesoTratado: 10, precoCaixa: 62.00, qtdComprimidosCaixa: 4, precoPorComprimido: 15.50, especie: "Cão", tipo: "Comprimido" },
  { id: "2", nome: "Endogard 30kg (Cães Grandes)", categoria: "Vermífugo", pesoTratado: 30, precoCaixa: 69.80, qtdComprimidosCaixa: 2, precoPorComprimido: 34.90, especie: "Cão", tipo: "Comprimido" },
  { id: "3", nome: "Endogard 10kg (Cães Médios)", categoria: "Vermífugo", pesoTratado: 10, precoCaixa: 55.60, qtdComprimidosCaixa: 4, precoPorComprimido: 13.90, especie: "Cão", tipo: "Comprimido" },
  { id: "4", nome: "Milbemax Mastigável (Cães de 5 a 25kg)", categoria: "Vermífugo", pesoTratado: 25, precoCaixa: 90.00, qtdComprimidosCaixa: 2, precoPorComprimido: 45.00, especie: "Cão", tipo: "Comprimido" },
  { id: "5", nome: "Top Dog Cães 10kg", categoria: "Vermífugo", pesoTratado: 10, precoCaixa: 59.20, qtdComprimidosCaixa: 4, precoPorComprimido: 14.80, especie: "Cão", tipo: "Comprimido" },
  { id: "6", nome: "Chemital Puppy Cães e Gatos", categoria: "Vermífugo", pesoTratado: 10, precoCaixa: 42.00, qtdComprimidosCaixa: 4, precoPorComprimido: 10.50, especie: "Ambos", tipo: "Comprimido" },
  { id: "7", nome: "Basken Plus Cães 5kg", categoria: "Vermífugo", pesoTratado: 5, precoCaixa: 35.60, qtdComprimidosCaixa: 4, precoPorComprimido: 8.90, especie: "Cão", tipo: "Comprimido" },
  { id: "8", nome: "Profender Spot-on Gatos até 2,5kg", categoria: "Vermífugo", pesoTratado: 2.5, precoCaixa: 75.00, qtdComprimidosCaixa: 1, precoPorComprimido: 75.00, especie: "Gato", tipo: "Transdérmico" },
  { id: "9", nome: "Profender Spot-on Gatos de 2,5 a 5kg", categoria: "Vermífugo", pesoTratado: 5, precoCaixa: 88.00, qtdComprimidosCaixa: 1, precoPorComprimido: 88.00, especie: "Gato", tipo: "Transdérmico" },
  { id: "10", nome: "Drontal Gatos", categoria: "Vermífugo", pesoTratado: 4, precoCaixa: 48.00, qtdComprimidosCaixa: 4, precoPorComprimido: 12.00, especie: "Gato", tipo: "Comprimido" },
];
